...
def save_medical_store(data):
    ...
    record = {
        ...
        'dl_issue_date': data.get('dl_issue_date'),
        'dl_expiry_date': data.get('dl_expiry_date'),
        'dl_issuing_authority': data.get('dl_issuing_authority', 'FDA Maharashtra'),
        'dl_renewal_date': data.get('dl_renewal_date', ''),
        'fssai_number': data.get('fssai_number'),
        'fssai_issue_date': data.get('fssai_issue_date', data.get('dl_issue_date')),
        'fssai_expiry_date': data.get('fssai_expiry_date'),
